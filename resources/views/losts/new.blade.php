...
<a href="/lostandfound"><img src="{{asset('admin/assets/img/toggle.png')}}" class="mt-4"></a>
    <h4 class="mt-4">Lost Property Information</h4>
      ...
      <div class="property-form-block" id="property_frm_section">
          ...
          <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="brand_id" class="control-label lbl-descriptive fs-5">Lost By</label><br>
                    <span class="label-detail f-6">(Owners Name)</span>
                  </label>
              ...
              <div class="form-group">
                  <label for="category_id" class="control-label lbl-descriptive fs-5">
                      Category<br>
                      <span class="label-detail fs-6">(Please select the category of the lost property)</span>
                  </label>
        ...
        <div class="col-sm-6">
          ...
          <div class="form-group mt-4">
            <label for="date" class="control-label lbl-descriptive fs-5">Date Lost<br>
              <span class="label-detail fs-6">Please add the approximate date of when the item was lost.</span>
            </label>
  
            <div class="col-sm-10">
              <input name="date_lost" type="datetime-local" class="form-control">
              <br>
            </div>
          </div>
          <div class="form-group col-sm-10">
            <label for="additional_information" class="control-label lbl-descriptive fs-5">Description Information Items<br>
              <span class="label-detail fs-6">Please provide any additional details/description of your lost property.</span>
            </label>
                  ...
                  <div class="col-sm-6">
                      <div class="form-group col-sm-12">
                          <label for="location_id" class="control-label lbl-descriptive fs-5">
                              Lost Location<br>
                              <span class="label-detail fs-6">Please select where the item was lost.</span>
                          </label>
                  ...
                  <div class="col-sm-6">
                      <div class="form-group col-sm-10">
                          <label for="additional_information" class="control-label lbl-descriptive fs-5">
                              Detail Location<br>
                              <span class="label-detail fs-6">Please provide any additional details/description of where you lost it.</span>
                          </label>
