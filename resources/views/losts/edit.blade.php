...
@section('page_title','Edit Barang Hilang')

@section('content')
    <h3>Edit Data Barang Hilang</h3>
    <div class="mt-5 col-12 m-auto">
        <form action="/losts/{{ $losts->id }}" method="post">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-1">
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <input type="text" id="photo" class="form-control" name="photo" value="{{  old('photo', $losts->photo) }}">
                </div>
                <div class="col-auto">
                    <span id="passwordHelpInLine" class="form-text text-danger">
                        @error('description')
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <input type="date" id="date_lost" class="form-control" name="date_lost" value="{{  old('date_lost', $losts->date_lost) }}">
                </div>
                <div class="col-auto">
                    <span id="passwordHelpInLine" class="form-text text-danger">
                        @error('description')
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <input type="text" id="category" class="form-control" name="category" value="{{  old('category', $losts->category) }}">
                </div>
                <div class="col-auto">
                    <span id="passwordHelpInLine" class="form-text text-danger">
                        @error('description')
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <input type="text" id="brand" class="form-control" name="brand" value="{{  old('brand', $losts->brand) }}">
                </div>
                <div class="col-auto">
                    <span id="passwordHelpInLine" class="form-text text-danger">
                        @error('description')
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <input type="text" id="lost_place" class="form-control" name="lost_place" value="{{  old('lost_place', $losts->lost_place) }}">
                </div>
                <div class="col-auto">
                    <span id="passwordHelpInLine" class="form-text text-danger">
                        @error('description')
